          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="mb-6 rounded-[42px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl backdrop-blur-xl overflow-hidden">
                ...
                <div className="relative mx-auto w-[340px] h-[340px] max-w-full">
                  <svg viewBox="0 0 340 340" className="absolute inset-0 w-full h-full">
                    <circle cx="170" cy="170" r="118" fill="none" stroke="rgba(255,255,255,0.07)" strokeWidth="34" />

                    <path
                      d="M 108 70 A 118 118 0 0 1 232 70"
                      fill="none"
                    ...
                    <path
                      d="M 270 108 A 118 118 0 0 1 270 232"
                      fill="none"
                    ...
                    <path
                      d="M 232 270 A 118 118 0 0 1 108 270"
                      fill="none"
                    ...
                    <path
                      d="M 70 232 A 118 118 0 0 1 70 108"
                      fill="none"
                  ...
                  <button
                    ...
                    className="absolute left-1/2 top-1/2 w-32 h-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#050816] border border-emerald-400/25 shadow-[0_0_45px_rgba(16,185,129,0.28)] flex flex-col items-center justify-center text-center active:scale-95 transition-all z-20"
                  >
                    <span className="text-4xl">🤖</span>
                    <p className="text-[10px] uppercase tracking-[0.22em] text-emerald-300 font-black mt-1">
                      SaveWise AI
                    </p>
                    <p className="text-yellow-400 text-xl font-black mt-2">
                  ...
                  <button
                    ...
                    className="absolute left-1/2 -top-2 -translate-x-1/2 text-center active:scale-95 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="absolute -right-2 top-1/2 -translate-y-1/2 text-center active:scale-95 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="absolute -left-2 top-1/2 -translate-y-1/2 text-center active:scale-95 transition-all"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setShowScoreInfo(true)}
                    className="absolute left-1/2 -bottom-2 -translate-x-1/2 text-center active:scale-95 transition-all"
                  >
                    <p className="text-[10px] uppercase tracking-[0.18em] text-purple-300 font-black">
                      Score
                    </p>
                    <p className="text-purple-400 text-lg font-black">
