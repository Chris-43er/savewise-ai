...
• Ausgabenschwerpunkt: ${topCategory} (${topCategoryAmount.toLocaleString("de-DE", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}€)
• Höchste Einzelbuchung: ${biggestExpense ? Math.abs(biggestExpense.amount).toLocaleString("de-DE", { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + "€" : "0,00€"}
    ...
    />
        ...
        {activeTab === "finance" && (
          <div className="space-y-1 mt-2">
            ...
            <div className={financeSection === "upload" ? "block pt-6 pb-40" : "hidden"}>
