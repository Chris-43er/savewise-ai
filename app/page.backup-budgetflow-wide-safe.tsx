      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="relative -mx-3 rounded-[28px] border border-emerald-400/10 bg-white/[0.025] p-3 shadow-[0_0_24px_rgba(16,185,129,0.08)]">
              <div className="absolute -inset-1 rounded-[38px] bg-emerald-400/5 blur-xl pointer-events-none" />
              <div className="rounded-[34px] border border-emerald-400/10 bg-white/[0.025] p-4 shadow-[0_0_24px_rgba(16,185,129,0.08)] backdrop-blur-xl">

              <div className="mb-6 rounded-[38px] border border-white/10 bg-white/[0.035] p-4 shadow-2xl backdrop-blur-xl overflow-hidden">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h2 className="text-2xl font-black text-white tracking-[0.12em] uppercase">
                      SaveWise BudgetFlow
                    </h2>
                  </div>
                ...
                <div className="mt-5 rounded-[30px] bg-white/[0.06] border border-white/10 p-4 space-y-3">
                  {(() => {
                    const income = monthlyIncome || 0;
                      ...
                      <>
                        {rows.map((row) => (
                          <button
                            ...
                            type="button"
                            onClick={row.onClick}
                            className="w-full rounded-[22px] bg-white/[0.035] border border-white/10 p-3 text-left active:scale-[0.985] transition-all"
                          >
                        ...
                        <div className="rounded-[22px] bg-emerald-400/10 border border-emerald-400/20 p-3">
                          <p className="text-[10px] uppercase tracking-[0.18em] text-emerald-300 font-black">
                            BudgetFlow Insight
                          </p>
                          <p className="text-white/75 mt-2 leading-snug text-sm">
                            {insight}
                          </p>
                        </div>
                      </>
