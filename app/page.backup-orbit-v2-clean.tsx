              ...
              <div className="mb-6 rounded-[42px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl backdrop-blur-xl overflow-hidden">
                <div className="mb-5">
                  ...
                  <p className="text-white/50 text-sm mt-1">
                    Tippe direkt auf einen Ringbereich
                  </p>
                </div>
                ...
                <div className="relative mx-auto w-[320px] h-[320px] max-w-full">
                  ...
                  >
                    ...
                    <path
                      d="M 96 68 A 112 112 0 0 1 224 68"
                      fill="none"
                    ...
                    <path
                      d="M 252 96 A 112 112 0 0 1 252 224"
                      fill="none"
                    ...
                    <path
                      d="M 224 252 A 112 112 0 0 1 96 252"
                      fill="none"
                    ...
                    <path
                      d="M 68 224 A 112 112 0 0 1 68 96"
                      fill="none"
                  ...
                  <button
                    ...
                    className="absolute left-1/2 top-1/2 w-28 h-28 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#050816] border border-emerald-400/25 shadow-[0_0_45px_rgba(16,185,129,0.25)] flex flex-col items-center justify-center text-center active:scale-95 transition-all z-20"
                  >
                  ...
                  <button
                    ...
                    className="absolute left-1/2 top-3 -translate-x-1/2 rounded-2xl bg-emerald-400/15 border border-emerald-400/30 px-4 py-2 text-center active:scale-95 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 rounded-2xl bg-red-400/15 border border-red-400/30 px-4 py-2 text-center active:scale-95 transition-all"
                  >
                    <p className="text-[9px] uppercase tracking-[0.16em] text-red-300 font-black">
                      Ausgaben
                    </p>
                  ...
                  <button
                    ...
                    className="absolute left-0 top-1/2 -translate-y-1/2 rounded-2xl bg-yellow-400/15 border border-yellow-400/30 px-4 py-2 text-center active:scale-95 transition-all"
                  >
                    <p className="text-[9px] uppercase tracking-[0.16em] text-yellow-300 font-black">
                      Übrig
                    </p>
                  ...
                  <button
                    type="button"
                    onClick={() => setShowScoreInfo(true)}
                    className="absolute left-1/2 bottom-3 -translate-x-1/2 rounded-2xl bg-purple-400/15 border border-purple-400/30 px-4 py-2 text-center active:scale-95 transition-all"
                  >
                    <p className="text-[9px] uppercase tracking-[0.16em] text-purple-300 font-black">
                      Score
                    </p>
                    <p className="text-purple-400 text-sm font-black mt-1">
