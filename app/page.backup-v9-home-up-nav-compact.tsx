    ...
    <>
      ...
      {showAppSplash && (
        <div className="fixed inset-0 z-[99999] bg-[#050816] flex flex-col items-center justify-center px-10">
          ...
          <h1 className="mt-8 text-2xl font-black text-white tracking-wide">
            SaveWise
          </h1>
      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-1.5 mt-6">
            ...
            <div className="relative -mx-6 rounded-[24px] border border-emerald-400/5 bg-white/[0.012] p-1 shadow-[0_0_8px_rgba(16,185,129,0.03)]">
              ...
              <div className="mb-3 rounded-[20px] border border-white/10 bg-white/[0.03] p-3 shadow-lg backdrop-blur-xl overflow-hidden">
                ...
                <div className="mt-3 rounded-[18px] bg-white/[0.04] border border-white/10 p-2 space-y-1.5">
                  {(() => {
                    const income = monthlyIncome || 0;
                    ...
                    return (
                      <>
                        ...
                        <div className="rounded-[14px] bg-emerald-400/10 border border-emerald-400/20 px-3 py-2">
            ...
            {homeSection === "contracts" && (
              <div className="space-y-1.5">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[52px] rounded-[16px] border border-white/10 bg-white/[0.025] px-4 py-2 text-left backdrop-blur-xl shadow-sm shadow-black/10 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
                ...
                <Panel isLightMode={isLightMode} title="Verträge & Fixkosten">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    ...
                    <div className="rounded-3xl bg-gray-100 border border-gray-200 p-5">
                      ...
                      <p className="text-xs font-black text-yellow-400 mt-0.5">
                    ...
                    {contractExpenses.map((item) => (
                      <div key={item.id} className="rounded-3xl bg-gray-100 border border-gray-200 p-5">
                        ...
                        {item.aiDetected && !item.confirmed && (
                          <div className="mt-0.5 rounded-2xl bg-yellow-400/15 border border-yellow-400/30 p-4">
                            ...
                            <button
                              ...
                              className="mt-0.5 bg-emerald-400 text-black px-5 py-3 rounded-2xl font-black"
                            >
  ...
  {[
    ...
    >
      ...
      <p className={
        homeSection === item.key
          ? "mt-0.5 text-white"
          : isLightMode ? "mt-0.5 text-black" : "mt-0.5 text-gray-300"
      }>
        {item.text}
      </p>
    </button>
            ...
            <div className={homeSection === "overview" ? "grid grid-cols-1 gap-4" : "grid grid-cols-1 gap-4 pt-28"}>
              ...
              <Panel isLightMode={isLightMode} title="Monatsvergleich">
                <div className="grid grid-cols-3 gap-1.5 mt-4 text-sm">
          ...
          <div className="space-y-1.5 mt-6">
            ...
            <div className={financeSection === "upload" ? "block pt-28" : "hidden"}>
              <Panel isLightMode={isLightMode} title="Kontoauszüge & Uploads">
                ...
                <label className="mt-6 flex items-center gap-1.5 bg-emerald-400 text-black px-6 py-4 rounded-2xl font-black cursor-pointer w-fit">
                  <Upload size={20} />
                  Datei auswählen
              ...
              <Panel isLightMode={isLightMode} title="Ausgaben & Verträge">
                ...
                <div className="mt-8 rounded-[28px] border border-gray-200 bg-gray-100 p-5">
                  ...
                  <div className="grid gap-4 mt-5">
                    ...
                    <label className="flex items-center gap-1.5 text-black font-bold">
                      <input
                        type="checkbox"
                  ...
                  <div className="space-y-1.5 mt-5">
                    ...
                    {manualExpenses.map((item) => (
                      <div key={item.id} className="flex items-center justify-between gap-1.5 rounded-2xl bg-white border border-gray-200 p-4">
                        <div>
                          <p className="font-black text-black">{item.name}</p>
