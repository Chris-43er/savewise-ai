            ...
            <div className="hidden">
              ...
              <div className="flex gap-1 mt-3 items-center">
                ...
                <button
                  type="button"
                  onClick={askAI}
                  className="fixed top-[104px] left-5 z-[9999] h-12 px-5 rounded-[24px] bg-[#1f1d24]/95 text-white font-black shadow-2xl backdrop-blur-xl flex items-center justify-center whitespace-nowrap bg-emerald-400 text-black rounded-2xl font-black"
                >
                  Fragen
                </button>
              </div>
    ...
    >
      ...
      <p className={
        ...
        {item.text}
            ...
            <div className={homeSection === "overview" ? "grid grid-cols-1 gap-4" : "grid grid-cols-1 gap-4 pt-6"}>
