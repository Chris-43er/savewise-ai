      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-1 mt-2">
            ...
            {homeSection === "overview" && (
<div id="home-menu" className="grid gap-1.5">
  {[
    {
      key: "compare",
...
<Panel isLightMode={isLightMode} title="Sparziel">
  ...
  className="fixed right-5 bottom-24 z-[9999] w-14 h-14 rounded-3xl bg-emerald-400/20 border border-emerald-400/30 backdrop-blur-xl flex items-center justify-center"
