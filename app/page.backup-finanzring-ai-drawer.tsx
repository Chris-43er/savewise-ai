        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 rounded-[44px] border border-emerald-400/40 bg-gradient-to-br from-emerald-400/15 via-cyan-400/10 to-transparent p-4 shadow-[0_0_70px_rgba(16,185,129,0.35)]">
