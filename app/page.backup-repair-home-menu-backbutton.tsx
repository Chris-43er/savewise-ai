      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-1 mt-2">
            ...
            {false && (
              <div className="space-y-1">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-black/55 border border-white/10 px-5 py-3 text-sm font-black text-white shadow-xl shadow-black/20 backdrop-blur-2xl active:scale-[0.98] transition-all"
                >
            ...
            <div className={homeSection === "overview" ? "grid grid-cols-1 gap-4" : "grid grid-cols-1 gap-3 pt-4"}>
