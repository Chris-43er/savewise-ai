    ...
    <div className="grid gap-3 mt-2">
      <div>
        ...
        <input
          ...
          className="w-full bg-gray-100 border border-gray-200 rounded-2xl px-4 py-3 text-black outline-none"
        />
      </div>
      ...
      <div>
        <p className="text-sm font-bold text-gray-300 mb-2">Bereits gespart</p>
        <input
          type="number"
          value={savedAmount || ""}
      ...
      <div className="rounded-2xl bg-white/[0.045] border border-white/10 p-4">
        ...
        <div className="mt-3 h-3 rounded-full bg-white/10 overflow-hidden">
          <div
            ...
            style={{ width: `${goalAmount > 0 ? Math.min(100, Math.round((savedAmount / goalAmount) * 100)) : 0}%` }}
          />
        </div>
        <p className="mt-2 text-emerald-400 font-black">
          {goalAmount > 0 ? Math.min(100, Math.round((savedAmount / goalAmount) * 100)) : 0}% erreicht
        </p>
      </div>
    </div>
  </Panel>
