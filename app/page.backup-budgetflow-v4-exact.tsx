        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="relative -mx-3 rounded-[28px] border border-emerald-400/10 bg-white/[0.025] p-3 shadow-[0_0_24px_rgba(16,185,129,0.08)]">
              ...
              <div className="rounded-[24px] border border-emerald-400/5 bg-white/[0.018] p-2 shadow-[0_0_10px_rgba(16,185,129,0.04)] backdrop-blur-xl">

              <div className="mb-4 rounded-[22px] border border-white/10 bg-white/[0.03] p-3 shadow-xl backdrop-blur-xl overflow-hidden">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="w-10 h-10 rounded-2xl bg-emerald-400/10 border border-emerald-400/20 flex items-center justify-center text-lg">
                    📊
                  </div>
                </div>

                <div className="mt-4 rounded-[20px] bg-white/[0.045] border border-white/10 p-2.5 space-y-2.5">
                  {(() => {
                    const income = monthlyIncome || 0;
                      ...
                      <>
                        {rows.map((row) => (
                          <button
                            ...
                            type="button"
                            onClick={row.onClick}
                            className="w-full rounded-[18px] bg-white/[0.03] border border-white/10 px-3 py-2.5 text-left active:scale-[0.985] transition-all"
                          >
                            ...
                            <div className="mt-2 h-3.5 rounded-full bg-white/10 overflow-hidden">
                              <div
                        ...
                        <div className="rounded-[18px] bg-emerald-400/10 border border-emerald-400/20 px-3 py-2.5">
                          <p className="text-[10px] uppercase tracking-[0.18em] text-emerald-300 font-black">
                            BudgetFlow Insight
                          </p>
                          <p className="text-white/70 mt-1 leading-snug text-sm">
                            {insight}
                          </p>
                        </div>
                      </>
