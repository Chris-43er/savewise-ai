        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="mb-6 rounded-[42px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl backdrop-blur-xl overflow-hidden">
                <div className="mb-5">
                  <p className="text-xs uppercase tracking-[0.24em] text-emerald-300 font-black">
                    SaveWise Orbit
                  </p>
                  <p className="text-white/50 text-sm mt-1">
                    Tippe auf einen Finanzpunkt
                  </p>
                </div>

                <div className="relative mx-auto w-[320px] h-[320px] max-w-full">
                  <div className="absolute inset-8 rounded-full border border-emerald-400/20 shadow-[0_0_55px_rgba(16,185,129,0.18)]" />
                  <div className="absolute inset-16 rounded-full border border-cyan-400/15" />

                  <button
                    type="button"
                    onClick={() => setIsAiHubOpen((open) => !open)}
                    className="absolute left-1/2 top-1/2 w-32 h-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#050816] border border-emerald-400/20 shadow-[0_0_45px_rgba(16,185,129,0.22)] flex flex-col items-center justify-center text-center z-20 active:scale-95 transition-all"
                  >
                    <span className="text-4xl">🤖</span>
                    <p className="text-[10px] uppercase tracking-[0.22em] text-emerald-300 font-black mt-1">
                      SaveWise
                    </p>
                  </button>
                  ...
                  <button
                    ...
                    className="absolute left-1/2 top-0 -translate-x-1/2 rounded-[24px] bg-emerald-400/15 border border-emerald-400/35 px-4 py-3 w-[150px] text-center shadow-[0_0_30px_rgba(16,185,129,0.25)] active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.16em] text-emerald-300 font-black">
                      Einkommen
                    </p>
                    <p className="text-emerald-400 text-lg font-black mt-1 truncate">
                      {monthlyIncome > 0 ? monthlyIncome.toLocaleString("de-DE", { maximumFractionDigits: 0 }) + "€" : "—"}
                    </p>
                  </button>
                  ...
                  <button
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 rounded-[24px] bg-red-400/15 border border-red-400/35 px-4 py-3 w-[140px] text-center shadow-[0_0_30px_rgba(248,113,113,0.20)] active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.16em] text-red-300 font-black">
                      Ausgaben
                    </p>
                    <p className="text-red-400 text-lg font-black mt-1 truncate">
                      {totalMonthlyExpenses > 0 ? totalMonthlyExpenses.toLocaleString("de-DE", { maximumFractionDigits: 0 }) + "€" : "—"}
                    </p>
                  </button>
                  ...
                  <button
                    ...
                    className="absolute left-0 top-1/2 -translate-y-1/2 rounded-[24px] bg-yellow-400/15 border border-yellow-400/35 px-4 py-3 w-[130px] text-center shadow-[0_0_30px_rgba(250,204,21,0.20)] active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.16em] text-yellow-300 font-black">
                      Übrig
                    </p>
                    <p className="text-yellow-400 text-lg font-black mt-1 truncate">
                  ...
                  <button
                    ...
                    className="absolute left-1/2 bottom-0 -translate-x-1/2 rounded-[24px] bg-purple-400/15 border border-purple-400/35 px-4 py-3 w-[150px] text-center shadow-[0_0_30px_rgba(192,132,252,0.20)] active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.16em] text-purple-300 font-black">
                      Score
                    </p>
                    <p className="text-purple-400 text-lg font-black mt-1 truncate">
                      {savingScore}/100 · {savingsRate}%
                    </p>
                  </button>
                </div>
              </div>
