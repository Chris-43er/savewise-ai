...
<Panel isLightMode={isLightMode} title="Verträge & Fixkosten">
            ...
            {homeSection === "overview" && topExpenseItems.length > 0 && (
              <div className={isLightMode ? "rounded-[24px] border border-gray-200 bg-white px-4 py-3 shadow-lg shadow-black/5" : "rounded-[24px] border border-white/10 bg-white/[0.045] px-4 py-3 shadow-lg shadow-black/20"}>
                ...
                <div className="mt-2 grid gap-2">
                  {topExpenseItems.map((item, index) => (
                    <div key={index} className="flex items-center justify-between gap-3">
                      ...
                      <p className="font-black text-red-400 whitespace-nowrap">
