            ...
            {homeSection === "contracts" && (
              <div className="space-y-1">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[46px] rounded-[14px] border border-white/10 bg-white/[0.025] px-4 py-2 text-left backdrop-blur-xl shadow-sm shadow-black/10 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
