                  ...
                  <div className={isLightMode ? "mt-3 rounded-2xl bg-white border border-gray-200 p-3 shadow-sm" : "mt-3 rounded-2xl bg-white/[0.045] border border-white/10 p-3"}>
                              ...
                              setSelectedImportFiles((current) => {
                                ...
                                setUploadStatus(
                                  next.length === 0
                                    ...
                                    : `${next.length} Datei${next.length === 1 ? "" : "en"} werden automatisch neu analysiert.`
                                );
                    ...
                    <div className="mt-3">
                      <button
                        ...
                        className={isLightMode ? "w-full rounded-2xl bg-gray-100 px-4 py-3 font-black text-black" : "w-full rounded-2xl bg-white/10 px-4 py-3 font-black text-white"}
                      >
                        Auswahl leeren
                      </button>
                    </div>
