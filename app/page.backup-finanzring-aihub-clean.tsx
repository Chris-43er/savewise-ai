      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="rounded-[34px] bg-white/5 border border-white/10 p-5 shadow-2xl">
              <p className="text-white text-xl font-black">
                Frage SaveWise AI
              </p>
            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="rounded-[44px] border border-emerald-400/25 bg-gradient-to-br from-emerald-400/10 via-cyan-400/10 to-transparent p-6 shadow-[0_0_70px_rgba(16,185,129,0.22)]">

              <div className="flex items-center justify-between gap-6">

                <div className="relative w-44 h-44 shrink-0 rounded-full border-[14px] border-emerald-400/25 shadow-[0_0_45px_rgba(16,185,129,0.35)] flex items-center justify-center">
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <button
                    ...
                    className="w-full rounded-2xl bg-white/10 border border-white/10 py-3 text-white font-black active:scale-[0.98] transition-all"
                  >
                    Ausgaben ansehen
                  </button>
