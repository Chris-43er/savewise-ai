      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && homeSection !== "overview" && (
          <button
            ...
            className="mb-5 ml-2 inline-flex h-12 px-5 rounded-[22px] bg-[#1f1d24]/95 text-white font-black shadow-2xl backdrop-blur-xl items-center justify-center whitespace-nowrap active:scale-[0.98] transition-all"
          >
            ← Zurück
          </button>
        )}
              ...
              <div className="space-y-1 pt-2">
                ...
                <Panel isLightMode={isLightMode} title="AI Insights">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                    ...
                    <div className="rounded-2xl bg-white/[0.045] border border-white/10 p-4">
                      <p className="text-white font-black">
                        Finanzstatus
                      </p>
...
<Panel isLightMode={isLightMode} title="Verträge & Fixkosten">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                    <div className="rounded-2xl bg-white/[0.045] border border-white/10 px-4 py-3">
                  ...
                  <div className="space-y-1 mt-2">
                    ...
                    {[...contractExpenses].sort((a, b) => b.amount - a.amount).map((item) => (
                      <div key={item.id} className="rounded-2xl bg-white/[0.045] border border-white/10 p-4">
                        <div className="flex items-center justify-between gap-4">
                          <div>
                        ...
                        <button
                          ...
                          className="mt-2 text-xs font-black text-red-300/90 underline underline-offset-4 active:scale-[0.98] transition-all"
                        >
                          Löschen
                        </button>
                      </div>
              ...
              <Panel isLightMode={isLightMode} title="Alle Ausgaben">
                <div className="space-y-1.5 mt-0">
                  ...
                  {allExpenseItems.map((item, index) => (
                    <div key={index} className="bg-white/[0.045] border border-white/10 px-4 py-3 rounded-2xl flex justify-between items-center">
                      <div>
