            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="mb-6 rounded-[42px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl backdrop-blur-xl overflow-hidden">
                <div className="mb-5">
                  ...
                  <div className="mt-4 rounded-3xl bg-cyan-400/10 border border-cyan-400/20 px-4 py-3 mb-5">
                    <p className="text-[10px] uppercase tracking-[0.18em] text-cyan-300 font-black">
                      AI Finanzstatus
                    </p>
                    <p className="text-2xl font-black text-white mt-1">
                      {aiFinanceStatus || aiInsight}
                    </p>
                  </div>
                </div>

                <div className="relative mx-auto w-[290px] h-[290px] max-w-full">
                  <svg viewBox="0 0 290 290" className="absolute inset-0 w-full h-full">
                    <circle cx="145" cy="145" r="96" fill="none" stroke="rgba(255,255,255,0.07)" strokeWidth="30" />

                    <path
                      d="M 91 66 A 96 96 0 0 1 199 66"
                      fill="none"
                    ...
                    <path
                      d="M 224 91 A 96 96 0 0 1 224 199"
                      fill="none"
                    ...
                    <path
                      d="M 199 224 A 96 96 0 0 1 91 224"
                      fill="none"
                    ...
                    <path
                      d="M 66 199 A 96 96 0 0 1 66 91"
                      fill="none"
                  ...
                  <button
                    type="button"
                    onClick={() => setShowScoreInfo(true)}
                    className="absolute left-1/2 top-1/2 w-28 h-28 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#050816] border border-emerald-400/25 shadow-[0_0_45px_rgba(16,185,129,0.28)] flex flex-col items-center justify-center text-center active:scale-95 transition-all z-20"
                  >
  ...
  {monthlyIncome > 0
    ...
    : "—"}
                  ...
                  <button
                    ...
                    className="absolute left-1/2 top-4 -translate-x-1/2 text-center active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.18em] text-emerald-300 font-black">
                      Einkommen
                    </p>
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-center active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.18em] text-red-300 font-black">
                      Ausgaben
                    </p>
                  ...
                  <button
                    ...
                    className="absolute left-2 top-1/2 -translate-y-1/2 text-center active:scale-95 transition-all z-30"
                  >
                    <p className="text-[10px] uppercase tracking-[0.18em] text-yellow-300 font-black">
                      Rest
                    </p>
                  ...
                  <button
                    type="button"
                    onClick={() => setShowScoreInfo(true)}
                    className="absolute left-1/2 -bottom-8 -translate-x-1/2 text-center active:scale-95 transition-all"
                  >
                    <p className="text-[10px] uppercase tracking-[0.18em] text-purple-300 font-black">
                      Score
                    </p>
