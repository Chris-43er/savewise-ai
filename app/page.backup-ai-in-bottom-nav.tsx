      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-1 mt-2">
            ...
            {homeSection === "contracts" && (
              <div className="space-y-1">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[42px] rounded-[14px] border border-white/10 bg-white/[0.025] px-4 py-2 text-left backdrop-blur-xl shadow-sm shadow-black/10 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
            ...
            {homeSection === "overview" && (
<div id="home-menu" className="grid gap-1.5 -mt-2 pb-32">
  {[
    {
      key: "compare",
...
<Panel isLightMode={isLightMode} title="Sparziel">
  ...
  className="z-[9999] w-14 h-14 rounded-[20px] bg-emerald-400/20 border border-emerald-300/30 shadow-xl shadow-emerald-400/20 backdrop-blur-2xl flex items-center justify-center text-2xl active:scale-95 transition-all shrink-0 self-center translate-y-0"
...
>
  <span className="text-lg">✨</span>
      ...
      <div className="fixed bottom-5 left-1/2 -translate-x-1/2 bg-black/85 border border-white/20 backdrop-blur-2xl rounded-full px-7 py-4 flex gap-8 shadow-2xl shadow-black/50 z-50">
