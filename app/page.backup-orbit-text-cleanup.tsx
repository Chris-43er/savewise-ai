  ...
  {monthlyIncome > 0
    ...
    : "—"}
                  ...
                  <button
                    ...
                    className="absolute left-1/2 -top-8 -translate-x-1/2 text-center active:scale-95 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-6 top-1/2 -translate-y-1/2 text-center active:scale-95 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="absolute left-6 top-1/2 -translate-y-1/2 text-center active:scale-95 transition-all"
                  >
