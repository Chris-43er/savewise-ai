                    ...
                    onChange={async (e) => {
                      ...
                      setUploadStatus(
                        files.length === 1
                          ...
                          : `${files.length} Dateien werden nacheinander analysiert...`
                      );
                      ...
                      for (const file of files) {
                        ...
                        if (fileName.endsWith(".pdf")) {
                          setUploadStatus(`PDF wird analysiert: ${file.name}`);
                          await analyzePdf(file);
                        } else if (fileName.endsWith(".csv")) {
                          setUploadStatus(`CSV wird analysiert: ${file.name}`);
                          ...
                          setUploadStatus(`Bild wird analysiert: ${file.name}`);
                          await analyzeImage(file);
                        } else {
                          setUploadStatus(`Dateiformat nicht unterstützt: ${file.name}`);
                        }
                      }
                      ...
                      setUploadStatus(
                        files.length === 1
                          ...
                          : `${files.length} Dateien analysiert.`
                      );
