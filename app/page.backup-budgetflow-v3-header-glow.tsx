          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="mb-6 rounded-[42px] border border-white/10 bg-white/[0.035] p-5 shadow-2xl backdrop-blur-xl overflow-hidden">
                ...
                <div className="mt-6 rounded-[34px] bg-white/[0.06] border border-white/10 p-5 space-y-5">
                  {(() => {
                    const income = monthlyIncome || 0;
                      ...
                      <>
                        {rows.map((row) => (
                          <button
                            ...
                            type="button"
                            onClick={row.onClick}
                            className="w-full rounded-[24px] bg-white/[0.035] border border-white/10 p-4 text-left active:scale-[0.985] transition-all"
                          >
                            <div className="flex items-center justify-between gap-3">
                              ...
                              <div className="text-right">
                                <p className={`${row.text} text-2xl font-black`}>
                                  {row.value > 0
                        ...
                        <div className="rounded-[24px] bg-emerald-400/10 border border-emerald-400/20 p-4">
