        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="relative rounded-[42px] border border-emerald-400/20 bg-gradient-to-br from-emerald-400/10 via-cyan-400/5 to-transparent p-4 shadow-[0_0_55px_rgba(16,185,129,0.16)]">
              ...
              <div className="rounded-[42px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between mb-5">
                <div>
                  ...
                  <p className="text-white/50 text-sm mt-1">
                    Einkommen, Ausgaben und Restbetrag
                  </p>
                </div>
                ...
                <button
                  ...
                  className="w-14 h-14 rounded-2xl bg-emerald-400/15 border border-emerald-400/20 flex items-center justify-center text-2xl active:scale-95 transition-all"
                >
                  🤖
                </button>
              </div>
              ...
              <div className="relative mx-auto w-72 h-72">
                ...
                <button
                  ...
                  className="absolute inset-0 rounded-full border-[18px] border-emerald-400/45 shadow-[0_0_40px_rgba(16,185,129,0.25)] active:scale-95 transition-all"
                  aria-label="Einkommen öffnen"
                />
                ...
                <button
                  ...
                  className="absolute inset-9 rounded-full border-[16px] border-red-400/40 shadow-[0_0_35px_rgba(248,113,113,0.18)] active:scale-95 transition-all"
                ...
                <button
                  ...
                  className="absolute inset-[72px] rounded-full border-[14px] border-yellow-400/45 shadow-[0_0_35px_rgba(250,204,21,0.18)] active:scale-95 transition-all"
                  aria-label="Übrig öffnen"
                />

                <div className="absolute inset-[108px] rounded-full bg-[#050816] border border-white/10 flex flex-col items-center justify-center text-center pointer-events-none">
                  <p className="text-[10px] uppercase tracking-[0.25em] text-yellow-300 font-black">
                    Übrig
                  </p>
              ...
              <div className="grid grid-cols-3 gap-3 mt-6 text-center">
                <button
                  ...
                  className="rounded-2xl bg-emerald-400/10 border border-emerald-400/20 p-3 active:scale-95 transition-all"
                >
                  <p className="text-[10px] text-white/50 font-black uppercase tracking-wider">
                    Einkommen
                  </p>
                  <p className="text-emerald-400 font-black mt-2 text-sm">
                    {monthlyIncome > 0
                ...
                <button
                  ...
                  className="rounded-2xl bg-red-400/10 border border-red-400/20 p-3 active:scale-95 transition-all"
                >
                  <p className="text-[10px] text-white/50 font-black uppercase tracking-wider">
                    Ausgaben
                  </p>
                  <p className="text-red-400 font-black mt-2 text-sm">
                ...
                <button
                  ...
                  className="rounded-2xl bg-yellow-400/10 border border-yellow-400/20 p-3 active:scale-95 transition-all"
                >
                  <p className="text-[10px] text-white/50 font-black uppercase tracking-wider">
                    Übrig
                  </p>
                  <p className="text-yellow-400 font-black mt-2 text-sm">
                    {monthlyIncome > 0
                      ? remainingAfterManual.toLocaleString("de-DE", {
                          maximumFractionDigits: 0
                        }) + "€"
  ...
  return (
    <div className="relative overflow-hidden bg-white/5 border border-white/10 rounded-[36px] p-10 shadow-2xl shadow-emerald-500/10">
      ...
      <div className="relative flex flex-col items-start text-left">
        <div className="relative mb-3 self-start ml-2">
          <div className="absolute inset-0 rounded-[20px] bg-emerald-400/20 blur-lg" />

          <img
            src="/savewise-icon.png"
            alt="SaveWise Logo"
            className="relative w-16 h-16 rounded-[18px] object-cover shadow-xl shadow-emerald-400/20"
          />
        </div>
