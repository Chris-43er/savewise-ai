            ...
            <div className="relative -mx-6 rounded-[24px] border border-emerald-400/5 bg-white/[0.012] p-1 shadow-[0_0_8px_rgba(16,185,129,0.03)]">
              ...
              <div className="mb-3 rounded-[20px] border border-white/10 bg-white/[0.03] p-3 shadow-lg backdrop-blur-xl overflow-hidden">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="w-9 h-9 rounded-xl bg-emerald-400/10 border border-emerald-400/20 flex items-center justify-center text-base">
                    📊
                  </div>
                </div>

                <div className="mt-4 rounded-[18px] bg-white/[0.04] border border-white/10 p-2 space-y-2">
                  {(() => {
                    const income = monthlyIncome || 0;
                      ...
                      <>
                        {rows.map((row) => (
                          <button
                            ...
                            type="button"
                            onClick={row.onClick}
                            className="w-full rounded-[16px] bg-white/[0.028] border border-white/10 px-3 py-2 text-left active:scale-[0.985] transition-all"
                          >
                        ...
                        <div className="rounded-[16px] bg-emerald-400/10 border border-emerald-400/20 px-3 py-2">
