...
<div className={analyseSection === "smart" ? "block pt-8" : "hidden"}>
  ...
  <div className="fixed inset-0 bg-black/70 backdrop-blur-xl z-50 flex items-center justify-center p-6">
    <div className="w-full max-w-lg bg-white border border-gray-200 rounded-[32px] p-8 shadow-2xl max-h-[90vh] overflow-y-auto">
      ...
      <div className="space-y-4 mt-8">
        ...
        <button
          ...
          className="w-full bg-black text-white rounded-2xl p-4 font-black"
        >
          Schließen
        </button>
      </div>
