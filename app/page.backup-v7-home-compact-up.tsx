            ...
            {homeSection === "contracts" && (
              <div className="space-y-3">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[72px] rounded-[20px] border border-white/10 bg-white/[0.035] px-5 py-3 text-left backdrop-blur-2xl shadow-lg shadow-black/15 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
