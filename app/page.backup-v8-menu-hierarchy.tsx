          ...
          <div className="space-y-2 mt-6">
            ...
            <div className="relative -mx-6 rounded-[24px] border border-emerald-400/5 bg-white/[0.012] p-1 shadow-[0_0_8px_rgba(16,185,129,0.03)]">
              ...
              <div className="mb-3 rounded-[20px] border border-white/10 bg-white/[0.03] p-3 shadow-lg backdrop-blur-xl overflow-hidden">
                ...
                <div className="mt-3 rounded-[18px] bg-white/[0.04] border border-white/10 p-2 space-y-2">
                  {(() => {
                    const income = monthlyIncome || 0;
            ...
            {homeSection === "contracts" && (
              <div className="space-y-2">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[58px] rounded-[18px] border border-white/10 bg-white/[0.03] px-4 py-2 text-left backdrop-blur-2xl shadow-md shadow-black/10 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
                    ...
                    {contractExpenses.map((item) => (
                      <div key={item.id} className="rounded-3xl bg-gray-100 border border-gray-200 p-5">
                        ...
                        {item.aiDetected && !item.confirmed && (
                          <div className="mt-1 rounded-2xl bg-yellow-400/15 border border-yellow-400/30 p-4">
                            ...
                            <button
                              ...
                              className="mt-1 bg-emerald-400 text-black px-5 py-3 rounded-2xl font-black"
                            >
      ...
      <p
        className={
          homeSection === item.key
            ...
            : isLightMode
            ? "text-sm font-black text-black"
            : isLightMode ? "text-sm font-black text-black" : "text-sm font-black text-white"
        }
      >
        {item.label}
      </p>
          ...
          <div className="space-y-2 mt-6">
            ...
            <div className={financeSection === "upload" ? "block pt-28" : "hidden"}>
              <Panel isLightMode={isLightMode} title="Kontoauszüge & Uploads">
                ...
                <label className="mt-6 flex items-center gap-2 bg-emerald-400 text-black px-6 py-4 rounded-2xl font-black cursor-pointer w-fit">
                  <Upload size={20} />
                  Datei auswählen
              ...
              <Panel isLightMode={isLightMode} title="Ausgaben & Verträge">
                ...
                <div className="mt-8 rounded-[28px] border border-gray-200 bg-gray-100 p-5">
                  ...
                  <div className="space-y-2 mt-5">
                    ...
                    {manualExpenses.map((item) => (
                      <div key={item.id} className="flex items-center justify-between gap-2 rounded-2xl bg-white border border-gray-200 p-4">
                        <div>
                          <p className="font-black text-black">{item.name}</p>
