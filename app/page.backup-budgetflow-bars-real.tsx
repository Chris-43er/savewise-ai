                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="text-white/50 text-sm mt-2">
                      Deine Ausgaben nach Bereichen sortiert.
                    </p>
                  </div>

                  <div className="w-14 h-14 rounded-2xl bg-emerald-400/15 border border-emerald-400/25 flex items-center justify-center text-2xl">
                    📊
                  </div>
                </div>

                <div className="mt-6 rounded-[34px] bg-white/[0.06] border border-white/10 p-5">
                  <div className="flex items-end justify-between gap-4">
                    ...
                    <button
                      ...
                      className="rounded-2xl bg-emerald-400/15 border border-emerald-400/25 px-4 py-3 text-emerald-300 font-black active:scale-95 transition-all"
                    >
                      ✨ AI fragen
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-5">
                    <button
                      ...
                      className="rounded-2xl bg-emerald-400/10 border border-emerald-400/20 p-4 text-left active:scale-95 transition-all"
                    >
                      <p className="text-white/45 text-xs font-black uppercase tracking-[0.14em]">
                        Einkommen
                      </p>
                      <p className="text-emerald-400 text-xl font-black mt-2">
                    ...
                    <button
                      ...
                      className="rounded-2xl bg-red-400/10 border border-red-400/20 p-4 text-left active:scale-95 transition-all"
                    >
                      <p className="text-white/45 text-xs font-black uppercase tracking-[0.14em]">
                        Ausgaben
                      </p>
                      <p className="text-red-400 text-xl font-black mt-2">
