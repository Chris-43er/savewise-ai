      ...
      <div className="max-w-5xl mx-auto space-y-1">
        ...
        {activeTab === "home" && (
          <div className="space-y-1 mt-2">
            ...
            <div className="relative -mx-6 -mt-14 rounded-[24px] border border-emerald-400/5 bg-white/[0.012] p-1 shadow-[0_0_8px_rgba(16,185,129,0.03)]">
            ...
            {homeSection === "contracts" && (
              <div className="space-y-1">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[58px] rounded-[18px] border border-white/10 bg-white/[0.03] px-4 py-2.5 text-left backdrop-blur-xl shadow-sm shadow-black/10 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
            ...
            {homeSection === "overview" && (
<div id="home-menu" className="grid gap-1.5 pb-28">
  {[
    {
      key: "compare",
    ...
    >
      ...
      <p className={
        ...
        {item.text}
            ...
            <div className={homeSection === "overview" ? "grid grid-cols-1 gap-4" : "grid grid-cols-1 gap-4 pt-36"}>
...
<Panel isLightMode={isLightMode} title="Sparziel">
  ...
  <div className="fixed inset-0 bg-black/70 backdrop-blur-xl z-50 flex items-center justify-center p-6">
    <div className="w-full max-w-lg bg-white border border-gray-200 rounded-[34px] p-8 shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="fixed left-4 right-4 bottom-32 z-[9998] rounded-[34px] bg-[#101522]/95 border border-emerald-400/20 p-5 shadow-[0_0_80px_rgba(16,185,129,0.35)] backdrop-blur-xl">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-12 h-12 rounded-2xl bg-white/10 text-white font-black"
            >
              ×
            </button>
          </div>
      ...
      <div className="fixed left-1/2 bottom-3 z-[9999] -translate-x-1/2 rounded-full border border-white/10 bg-black/90 px-8 py-3 shadow-2xl backdrop-blur-2xl flex items-center gap-8">
        ...
        <button
          ...
          className="w-12 h-12 rounded-full flex items-center justify-center text-2xl active:scale-95 transition-all"
