            ...
            <div className="relative -mx-6 rounded-[24px] border border-emerald-400/5 bg-white/[0.012] p-1 shadow-[0_0_8px_rgba(16,185,129,0.03)]">
              ...
              <div className="mb-3 rounded-[20px] border border-white/10 bg-white/[0.03] p-3 shadow-lg backdrop-blur-xl overflow-hidden">
                <div className="flex items-center justify-center">
                  <div>
                    <h2 className="text-2xl font-black text-white tracking-[0.12em] uppercase text-center w-full">
                      SaveWise BudgetFlow
                    </h2>
                  </div>
            ...
            {homeSection === "contracts" && (
              <div className="space-y-5">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="bg-[#1f1f24] text-white px-6 py-4 rounded-[24px] font-black shadow-xl active:scale-[0.98] transition-all duration-300"
                >
                  ← Zurück zur Übersicht
                </button>
                    ...
                    {contractExpenses.map((item) => (
                      <div key={item.id} className="rounded-3xl bg-gray-100 border border-gray-200 p-5">
                        ...
                        <button
                          ...
                          className="w-full mt-1 bg-red-400 text-white rounded-2xl py-3 font-black"
                        >
                          Löschen
                        </button>
                      </div>
