        ...
        {activeTab === "home" && (
          <div className="space-y-6 mt-6">
            ...
            <div className="relative -mx-3 rounded-[28px] border border-emerald-400/10 bg-white/[0.025] p-3 shadow-[0_0_24px_rgba(16,185,129,0.08)]">
              ...
              <div className="rounded-[28px] border border-emerald-400/10 bg-white/[0.025] p-3 shadow-[0_0_16px_rgba(16,185,129,0.05)] backdrop-blur-xl">

              <div className="mb-5 rounded-[26px] border border-white/10 bg-white/[0.035] p-3 shadow-2xl backdrop-blur-xl overflow-hidden">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="w-11 h-11 rounded-2xl bg-emerald-400/10 border border-emerald-400/20 flex items-center justify-center text-xl">
                    📊
                  </div>
                </div>

                <div className="mt-4 rounded-[24px] bg-white/[0.06] border border-white/10 p-3 space-y-3">
                  {(() => {
                    const income = monthlyIncome || 0;
