            ...
            {homeSection === "contracts" && (
              <div className="space-y-5">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full rounded-[20px] border border-white/10 bg-white/5 px-5 py-3 text-left backdrop-blur-2xl shadow-lg shadow-black/20 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
