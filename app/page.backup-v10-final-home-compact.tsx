            ...
            {homeSection === "contracts" && (
              <div className="space-y-1.5">
                <button
                  type="button"
                  onClick={() => setHomeSection("overview")}
                  className="w-full min-h-[48px] rounded-[14px] border border-white/10 bg-white/[0.025] px-4 py-1.5 text-left backdrop-blur-xl shadow-sm shadow-black/10 active:scale-[0.98] transition-all"
                >
                  ← Zurück zur Übersicht
                </button>
          ...
          <div className="space-y-1.5 mt-2">
            ...
            <div className={financeSection === "upload" ? "block pt-28" : "hidden"}>
              <Panel isLightMode={isLightMode} title="Kontoauszüge & Uploads">
                ...
                <label className="mt-2 flex items-center gap-1.5 bg-emerald-400 text-black px-6 py-4 rounded-2xl font-black cursor-pointer w-fit">
                  <Upload size={20} />
                  Datei auswählen
